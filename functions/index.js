...
exports.videoInfo = functions.https.onRequest((req, res) => {
    ...
    ytdl.getInfo(URL, (err, info) => {
      ...
      console.log(info.iurlhq);
      console.log(info.iurlmq);
      console.log(info.iurlsd);
      console.log(info.player_response.videoDetails.thumbnail.thumbnails[info.player_response.videoDetails.thumbnail.thumbnails.length - 1].url);
      response = {
        title: info.title,
        id: info.video_id,
    ...
    //Thumbnail url can also be found at https://img.youtube.com/vi/${videoID}/maxresdefault.jpg
})
